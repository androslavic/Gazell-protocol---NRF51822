...
extern void RingBufInit(tRingBufObject *ptRingBuf, unsigned char *pucBuf,
                        unsigned long ulSize);
extern void RewindIndexAtomic(volatile unsigned long *pulVal, unsigned long ulDelta);
extern signed char RingBufQueueRead(tRingBufObject *ptRingBuf, unsigned char *pucData,
                        unsigned char * ulLength);
extern signed char RingBufQueueWrite(tRingBufObject *ptRingBuf, unsigned char *pucData,
                        unsigned long ulLength);
